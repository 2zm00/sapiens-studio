...
export const metadata: Metadata = {
  title: "개인정보처리방침",
  description: `${BRAND.name}에서 촬영한 사진은 기기에서만 처리되고 서버에 저장되지 않습니다.`,
    ...
    <main className="mx-auto w-full max-w-3xl px-6 py-16">
      ...
      <div className="mt-10 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        <section className="space-y-2">
          ...
          <p>
            {BRAND.name}(이하 “서비스”)에서의 촬영·합성·다운로드 등 모든 처리가 이용자의 브라우저(기기)
        ...
        <section className="space-y-2">
          ...
          <p>
            촬영을 위해 브라우저의 카메라 접근 권한이 필요합니다. 카메라
        ...
        <section className="space-y-2">
          ...
          <p>
            개인정보 처리에 관한 문의는 운영자 연락처로 접수할 수 있습니다.
          </p>
        </section>
